...
export declare class ReservasService {
    ...
    private readonly promociones;
    constructor(prisma: PrismaService, izipay: IzipayService, promociones: PromocionesService);
    crear(datos: {
    ...
    misReservas(usuarioId: string): Prisma.PrismaPromise<({
        salidaTransporte: ({
            transporte: {
                origenNombre: string;
